...
const getSchema = (lang: "pl" | "en") => z.object({
  title: z.string().trim().min(3, lang === "pl" ? "Tytuł musi mieć minimum 3 znaki" : "Title must be at least 3 characters"),
  category: z.string().min(1, lang === "pl" ? "Wybierz kategorię" : "Select a category"),
  amount: z.coerce.number().positive(lang === "pl" ? "Kwota musi być większa niż 0" : "Amount must be greater than 0"),
...
function BudgetPage() {
  ...
  const defaultCategories = lang === "pl"
    ? ["Lot", "Mieszkanie", "Depozyt", "Transport", "Jedzenie", "Ubezpieczenie", "Atrakcje", "Inne"]
    : ["Flight", "Accommodation", "Deposit", "Transport", "Food", "Insurance", "Attractions", "Other"];
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: { title: "", category: lang === "pl" ? "Inne" : "Other", amount: 0, currency: "EUR", isMonthly: false },
  });
